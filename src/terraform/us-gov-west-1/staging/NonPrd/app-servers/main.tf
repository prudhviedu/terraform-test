...
terraform {
  backend "s3" {
    ...
    key            = "terraform.tfstate.mel-nonprd-app-servers"
...
#NonPrd App Servers (5) 
module "Cemquaapmel400_Module" {
  ...
  tags                   = "${merge(
                              "${map("Name", "Cemquaapmel400"
                              )}",
                              "${local.tags}"
                          )}"
 }
 module "Cemquaapmel401_Module" {
  source = "../../../../modules/mel-server"
  env                    = "${var.env}"
  vpc                    = "${var.vpc}"
  instance_role          = "${local.instance_role}"
  ...
  subnet_id              = "${local.subnet_id}"
  tags                   = "${merge(
                              "${map("Name", "Cemquaapmel401"
                              )}",
                              "${local.tags}"
                          )}"
 }
  module "Cemquaapmel402_Module" {
  source = "../../../../modules/mel-server"
  env                    = "${var.env}"
  vpc                    = "${var.vpc}"
  instance_role          = "${local.instance_role}"
  ...
  subnet_id              = "${local.subnet_id}"
  tags                   = "${merge(
                              "${map("Name", "Cemquaapmel402"
                              )}",
                              "${local.tags}"
                          )}"
 }
  module "Cemquaapmel403_Module" {
  source = "../../../../modules/mel-server"
  env                    = "${var.env}"
  vpc                    = "${var.vpc}"
  instance_role          = "${local.instance_role}"
  ...
  subnet_id              = "${local.subnet_id}"
  tags                   = "${merge(
                              "${map("Name", "Cemquaapmel403"
                              )}",
                              "${local.tags}"
                          )}"
 }
  module "Cemquaapmel404_Module" {
  source = "../../../../modules/mel-server"
  env                    = "${var.env}"
  vpc                    = "${var.vpc}"
  instance_role          = "${local.instance_role}"
